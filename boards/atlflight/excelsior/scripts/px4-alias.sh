...
alias rgbled='px4-rgbled --instance $px4_instance'
alias linux_sbus='px4-linux_sbus --instance $px4_instance'
...
alias muorb_test='px4-muorb_test --instance $px4_instance'
...
alias sih='px4-sih --instance $px4_instance'
