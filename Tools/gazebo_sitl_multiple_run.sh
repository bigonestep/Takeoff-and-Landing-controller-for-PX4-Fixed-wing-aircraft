...
if [ "$PX4_SIM_MODEL" != "iris" ] && [ "$PX4_SIM_MODEL" != "plane" ] && [ "$PX4_SIM_MODEL" != "standard_vtol" ] && [ "$PX4_SIM_MODEL" != "r1_rover" ]
then
	echo "Currently only the following vehicle models are supported! [iris, plane, standard_vtol, r1_rover]"
	exit 1
fi
